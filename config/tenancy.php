...
return [
     ...
     */
    'redis' => [
        'prefix_base' => 'tenant', // Prefix format: tenant_{tenant_id}:{key}
        'prefixed_connections' => [
            'default', // Used by sessions, broadcast, and direct Redis calls
            'cache',   // Used by the Cache facade in tenant context
        ],
    ],
