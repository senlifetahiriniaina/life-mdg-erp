...
Route::middleware(['auth:sanctum', 'role:hr-manager,accountant,finance-manager,manager,admin'])->group(function () {
...
Route::middleware(['auth:sanctum'])->prefix('v1/payroll')->group(function () {
