...
/**
 * @group Validation — AI Assist
 *
 * Contextual AI guidance for Validation module actions.
 */
class ValidationAiAssistController extends Controller
{
    ...
    /**
     * POST /api/v1/validation/ai/assist
     *
     * Returns contextual AI guidance for a Validation action.
     *
