...
/**
 * @group Helpdesk — AI Assist
 *
 * Contextual AI guidance for Helpdesk module actions.
 */
class HelpdeskAiAssistController extends Controller
{
    ...
    /**
     * POST /api/v1/helpdesk/ai/assist
     *
     * Returns contextual AI guidance for a Helpdesk action.
     *
