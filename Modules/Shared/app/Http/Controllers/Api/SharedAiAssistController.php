...
/**
 * @group Shared — AI Assist
 *
 * Contextual AI guidance for Shared module actions.
 */
class SharedAiAssistController extends Controller
{
    ...
    /**
     * POST /api/v1/shared/ai/assist
     *
     * Returns contextual AI guidance for a Shared action.
     *
