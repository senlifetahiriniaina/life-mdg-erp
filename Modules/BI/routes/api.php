...
Route::middleware(['auth:sanctum', 'module:BI', 'role:manager,admin', 'throttle:simple_get'])->prefix('v1')->group(function () {
    // Queries - reads
...
Route::middleware(['auth:sanctum', 'module:BI', 'role:manager,admin', 'throttle:create_post'])
    ->prefix('v1')
    ->group(function () {
