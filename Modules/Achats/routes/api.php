...
Route::middleware(['auth:sanctum', 'role:purchasing-manager,warehouse-operator,manager,admin', 'throttle:simple_get'])->group(function () {
    // Purchase Orders
...
Route::middleware(['auth:sanctum'])->prefix('v1/achats')->group(function () {
