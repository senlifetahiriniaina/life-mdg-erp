...
/**
 * @group Achats — AI Assist
 *
 * Contextual AI guidance for Achats module actions.
 */
class AchatsAiAssistController extends Controller
{
    ...
    /**
     * POST /api/v1/achats/ai/assist
     *
     * Returns contextual AI guidance for a Achats action.
     *
