...
// Chantier 32.16 (Sales deep 14-layer audit): SalesIndex.vue's "Edit"
// (pencil) button has always navigated to /sales/orders/{id}/edit, a route
// that never existed anywhere (confirmed via a real HTTP request returning
// 404 before this fix). Built against the real PUT /api/v1/sales/orders/
// {id} contract (SalesController::updateOrder() — header fields only, no
// line-item editing, and draft-only, matching SalesOrder::isEditable()).
