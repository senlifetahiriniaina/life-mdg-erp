...
const canApprove = computed(() => roles.value.some(r => ['sales-manager','manager','admin','super-admin'].includes(r)))
const canDelete = computed(() => roles.value.some(r => ['admin','super-admin'].includes(r)))
