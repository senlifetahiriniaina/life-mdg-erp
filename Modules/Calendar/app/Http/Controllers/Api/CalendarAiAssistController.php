...
/**
 * @group Calendar — AI Assist
 *
 * Contextual AI guidance for Calendar module actions.
 */
class CalendarAiAssistController extends Controller
{
    ...
    /**
     * POST /api/v1/calendar/ai/assist
     *
     * Returns contextual AI guidance for a Calendar action.
     *
