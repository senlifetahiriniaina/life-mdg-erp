...
Route::middleware(['auth:sanctum', 'session.security', 'tenancy.user', 'module:Calendar', 'role:employee,manager,admin'])->prefix('v1')->group(function () {
...
Route::middleware(['auth:sanctum', 'session.security', 'tenancy.user'])->prefix('v1/calendar')->group(function () {
