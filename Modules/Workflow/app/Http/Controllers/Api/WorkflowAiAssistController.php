...
/**
 * @group Workflow — AI Assist
 *
 * Contextual AI guidance for Workflow module actions.
 */
class WorkflowAiAssistController extends Controller
{
    ...
    /**
     * POST /api/v1/workflow/ai/assist
     *
     * Returns contextual AI guidance for a Workflow action.
     *
